...
## Caution!!! This is a modified version of V10 for Telstra logos and login theme and is compatible ONLY with epicon customized HomeIdp Plugin for version 25.0.1 build in July 2024. Earlier version of the HomeIdp is not compatible and future versions of the plugin might not be either. 
